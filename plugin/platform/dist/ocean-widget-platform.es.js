...
var r = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), i = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}, o = (e = "widget") => `${e} is powered by ${a.name}`, s = (e = {}) => n(() => ({
	...a,
	...e
}), [e]), c = /* @__PURE__ */ r(((e) => {
	...
	whiteSpace: "nowrap"
}, h = ({ widgetName: e, message: t }) => {
	let n = s(), r = e || n.name;
	return /* @__PURE__ */ (0, u.jsxs)("div", {
		style: d,
		role: "note",
		"aria-label": "ocean widget platform placeholder",
		children: [
			/* @__PURE__ */ (0, u.jsx)("span", {
				style: f,
				children: "ocean-widget-platform"
			}),
			/* @__PURE__ */ (0, u.jsx)("span", {
				style: p,
				children: t || o(r)
...
}, g = e(a), _ = ({ value: e, children: t }) => {
	let r = n(() => ({
		...a,
		...e
	}), [e]);
	return /* @__PURE__ */ (0, u.jsx)(g.Provider, {
		value: r,
		children: t
	});
}, v = () => t(g);
//#endregion
export { h as PlatformPlaceholder, _ as PlatformShellProvider, o as formatPlatformTagline, a as platformIdentity, s as usePlatformInfo, v as usePlatformShell };
